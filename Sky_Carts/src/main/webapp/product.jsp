...
<body style="background-color: #f0f1f2;">
	<%@include file="component/navbar.jsp"%>
		<div class="container-fluid p-4 mt-5 bg-custom bg-primary border-outline-white">
			<div class="row">
										...
										<div class="card-body">
											...
											<%-- <div class="row">
												<a href="view_product.jsp?id=<%=p.getId()%>"
													...
													Details</a> <a href="#"
													class="btn btn-sm btn-danger col-md-4 ms-1">&#8364;
 <%=p.getPrice() %></a>
											</div> --%>
											...
											<div class="row text-center">
												<p class="fs-6 fw-bold">
													...
													%>
													<span
														class="fs-7 text-decoration-line-through text-secondary"><%=p.getDiscountBeforePrice()%></span>
													...
													<span class="fs-6  text-success"><%=p.getDiscount()%>%
														off</span>
												</p>

												<a href="view_product.jsp?id=<%=p.getId()%>"
													class="btn btn-sm btn-primary col-md-6 ms-5">View
													Details</a>
											</div>
